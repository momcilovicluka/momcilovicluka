...
- [yuliskov/SmartTube](https://github.com/yuliskov/SmartTube) ([23.10](https://github.com/yuliskov/SmartTube/releases/tag/23.10), 3 days ago) - SmartTube - an advanced player for set-top boxes and tvs running Android OS
- [JaKooLit/Hyprland-Dots](https://github.com/JaKooLit/Hyprland-Dots) ([v2.3.2](https://github.com/JaKooLit/Hyprland-Dots/releases/tag/v2.3.2), 5 days ago) - Hyprland dotfiles - used as main repo for all my Hyprland Install Scripts.
