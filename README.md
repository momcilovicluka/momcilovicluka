...
- [momcilovicluka/anirest](https://github.com/momcilovicluka/anirest) - Spring REST api for anime and anime lists. Faculty project for CBD/RZK (5 days ago)
...
- [karlstav/cava](https://github.com/karlstav/cava) ([0.10.1](https://github.com/karlstav/cava/releases/tag/0.10.1), 4 days ago) - Cross-platform Audio Visualizer
- [JaKooLit/Hyprland-Dots](https://github.com/JaKooLit/Hyprland-Dots) ([v2.2.4](https://github.com/JaKooLit/Hyprland-Dots/releases/tag/v2.2.4), 2 weeks ago) - Hyprland dots, used as main repo for all my Hyprland Install Scripts.
