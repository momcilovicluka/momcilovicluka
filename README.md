...
- [yuliskov/SmartTube](https://github.com/yuliskov/SmartTube) ([23.30s](https://github.com/yuliskov/SmartTube/releases/tag/23.30s), today) - SmartTube - an advanced player for set-top boxes and tvs running Android OS
- [JaKooLit/Hyprland-Dots](https://github.com/JaKooLit/Hyprland-Dots) ([v2.3.3-Ubuntu-24.04](https://github.com/JaKooLit/Hyprland-Dots/releases/tag/v2.3.3-Ubuntu-24.04), 3 days ago) - Hyprland dotfiles - used as main repo for all my Hyprland Install Scripts.
